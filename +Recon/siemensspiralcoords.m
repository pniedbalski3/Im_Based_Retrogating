function traj = siemensspiralcoords(Dwell,FOV,Res,SType,NSpi,Hubs,Alpha,USamp,BW_Scale,Ordering,Delay,Nucleus)
...
mgrad = 22*BW_Scale;  %PJN - Hardcode to what is on scanner
...
%% Compute
%call c/c++ functions
[coords,Grads] = bnispiralgen(dwell, xdely, ydely, zdely, mslew, mgrad,...
