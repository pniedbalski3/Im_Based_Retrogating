function newtraj = traj_delay_correction(traj,Dwell,Delay)

%% Function to adjust trajectories for a delay
%I'm going to try to make a delay correction that is rigorous - Actually
%using time rather than just percentages
