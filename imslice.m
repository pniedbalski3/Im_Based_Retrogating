...
h.im_uipanel = uipanel('BorderType','none','Units','pixels','Parent',figure_handle,'BackgroundColor','white'); %ba
...
h.scroll_uipanel = uipanel('BorderType','none','Units','pixels','Parent',figure_handle,'BackgroundColor','white'); %ba
